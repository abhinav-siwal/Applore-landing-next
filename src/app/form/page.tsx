...
const Page = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center  text-white">
      <div className="w-full max-w-[1100px] h-[800px] p-6 bg-[#12191B] rounded-lg shadow-md relative overflow-hidden">
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
    ...
    {/* First row for Name and Company */}
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {/* Second row for Email and Phone */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
          ...
          {/* Last row for Brief Description */}
          <div>
          ...
          <div className="w-full flex justify-center">
             {/* Button */}
        <button  type="submit" className="mt-8 bg-black text-white inter-regular px-6 py-3 rounded-full flex items-center space-x-2 ">
          <span>Submit</span>
          <Image
