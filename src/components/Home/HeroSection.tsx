...
const HeroSection = () => {
  return (
    <div className="relative w-full h-[45rem] bg-[#12191B]">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_#5E6EF9,_#10A4F2,_#12191B)]">
      </div>
      ...
      <div className="absolute bottom-20 w-full text-center text-gray-500 text-lg bricolage-grotesque-light">
        Trusted By
      </div>
